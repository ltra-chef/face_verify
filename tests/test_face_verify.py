...
PERSON1A = os.path.join(IMG_DIR, "person1a.jpg")
PERSON1B = os.path.join(IMG_DIR, "person1b.jpg")
PERSON2A = os.path.join(IMG_DIR, "person2a.jpg")
...
def test_same_person():
    ...
    output = run_cli(PERSON1A, PERSON1B)
...
def test_different_person():
    ...
    output = run_cli(PERSON1A, PERSON2A)
...
def test_with_different_models(model):
    ...
    output = run_cli(PERSON1A, PERSON1B, "--model", model)
